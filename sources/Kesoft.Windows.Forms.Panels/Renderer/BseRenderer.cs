...
namespace Kesoft.Windows.Forms.Panels
{
    ...
    public class BseRenderer : ToolStripProfessionalRenderer
    {
        ...
        /// </summary>
        public BseRenderer()
            : base(new Kesoft.Windows.Forms.Panels.ColorTableBlack())
        {
        ...
        /// </summary>
        /// <param name="professionalColorTable">A <see cref="Kesoft.Windows.Forms.Panels.ProfessionalColorTable"/> to be used for painting.</param>
        ...
        protected override void OnRenderArrow(ToolStripArrowRenderEventArgs e)
        {
            ...
            {
                ProfessionalColorTable colorTable = ColorTable as Kesoft.Windows.Forms.Panels.ProfessionalColorTable;
