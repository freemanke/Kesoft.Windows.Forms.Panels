...
namespace Kesoft.Windows.Forms.Panels
{
    ...
    public class BasePanel : ScrollableControl, IPanel
	{
        ...
        private Kesoft.Windows.Forms.Panels.ColorScheme m_eColorScheme;
        ...
        [DefaultValue(0)]
		[Category("Appearance")]
		public virtual Kesoft.Windows.Forms.Panels.PanelStyle PanelStyle
		{
		...
		[DefaultValue(Kesoft.Windows.Forms.Panels.ColorScheme.Professional)]
		[Browsable(true)]
		[Category("Appearance")]
		public virtual Kesoft.Windows.Forms.Panels.ColorScheme ColorScheme
		{
